...
def build_radioitems(id, item_list): #création d'un radioitems
    return dcc.RadioItems(id="{}".format(id),
                        value=item_list[0], 
        options=item_list,)

def build_slider(id): #création d'un slider
...
def init_graph(id_graph): #initialisation des graphs
    return dcc.Graph(id="{}".format(id_graph))

def build_piechart(data): #création de la piechart
...
def build_histogramme(data): #création de l'histogramme
...
def build_distmarge(data):#création de la distribution marginale
...
def build_animation(data): #création de l'animation
	animation = px.bar(
...
def build_linegraph(data):#création du line graphique
...
def build_3dplot(data, radiovalue):#création du 3d plot
...
def build_scatterplot(data):#création du scatter plot
...
def build_boxplot(data):#création du boxplot
